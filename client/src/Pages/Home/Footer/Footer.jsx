    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="footer--brand">
          <img src="/img/hbxlogo-192.png" alt="Habix Technologies" />
          <p className="footer--tagline">
            Powering digital transformation through blockchain innovation.
          </p>
        </div>

        <nav className="footer--items" aria-label="Footer">
          <ul>
            {FOOTER_LINKS.map(({ to, label }) => (
              <li key={to}>
                <Link to={to} className="text-md">
                  {label}
                </Link>
              </li>
            ))}
            <li>
              <a href="/profile.pdf" download className="text-md">
                Company Profile
              </a>
            </li>
          </ul>
      ...
      <div className="footer--content--container">
        <p className="footer--content">
          © {new Date().getFullYear()} Habix Technologies. All rights reserved.
        </p>
        <p className="footer--content">
          <a href="mailto:main@habixgroup.top">main@habixgroup.top</a>
        </p>
      </div>
    </footer>
  );
